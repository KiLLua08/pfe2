  ...
  <footer className="pt-7">
    <div className="container">
      ...
      <div className="row mb-7 gy-4">
        ...
        <div className="offset-xl-2 col-xl-5 col-md-6 col-lg-6">
      ...
      <div className="row row-cols-1 row-cols-lg-5" id="ft-links">
        <div className="col">
          <div className="position-relative">
            <div className="mb-2 d-flex justify-content-between border-bottom border-bottom-lg-0">
              <h5 className="">Landings</h5>
              <a
        ...
        <div className="col">
          <div>
            <div className="mb-2 d-flex justify-content-between border-bottom border-bottom-lg-0 position-relative">
    ...
    <div className="container mt-7 pb-4">
